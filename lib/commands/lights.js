...
var columnsDefault = 'id,name,status,brightness,reachable';

// columns default with -l
var columnsDefaultLong = 'uniqueid,id,name,status,brightness,type,modelid,swversion,reachable';
